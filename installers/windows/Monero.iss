...
; See LICENSE
#define GuiVersion GetFileVersion("bin\gyro-wallet-gui.exe")
...
UninstallDisplayIcon={app}\gyro-wallet-gui.exe
...
AppPublisherURL=https://getgyro.org
TimeStampsInUTC=yes
...
Source: "bin\gyro-wallet-gui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\gyro-gui-wallet-guide.pdf"; DestDir: "{app}"; Flags: ignoreversion

; Monero CLI wallet
Source: "bin\extras\gyro-wallet-cli.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\gyro-gen-trusted-multisig.exe"; DestDir: "{app}"; Flags: ignoreversion

; Monero wallet RPC interface implementation
Source: "bin\extras\gyro-wallet-rpc.exe"; DestDir: "{app}"; Flags: ignoreversion

; Monero daemon
Source: "bin\gyrod.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "bin\extras\gyro-blockchain-export.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\gyro-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\gyro-blockchain-mark-spent-outputs.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\gyro-blockchain-usage.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\gyro-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\gyro-blockchain-ancestry.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\gyro-blockchain-depth.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\gyro-blockchain-prune-known-spent-data.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\gyro-blockchain-prune.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\gyro-blockchain-stats.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\gyro-gen-ssl-cert.exe"; DestDir: "{app}"; Flags: ignoreversion
...
; Filename: "{app}\gyro-wallet-gui.exe"; Description: "Run GUI Wallet now"; Flags: postinstall nowait skipifsilent
...
begin
  ...
  blockChainDefaultDir := ExpandConstant('{commonappdata}\gyro');
  ...
  RegQueryStringValue(HKEY_CURRENT_USER, 'Software\gyro-project\gyro-core', 'blockchainDataDir', blockChainDir);
...
begin
  if CurStep = ssPostInstall then begin
    // Re-build "gyro-daemon.bat" according to actual install and blockchain directory used
    SetArrayLength(s, 3);
    s[0] := 'REM Execute the Monero daemon and then stay with window open after it exits';
    s[1] := '"' + ExpandConstant('{app}\gyrod.exe') + '" ' + DaemonFlags('');
    s[2] := 'PAUSE';
...
[Icons]
; Icons in the "Gyro GUI Wallet" program group
; Windows will almost always display icons in alphabetical order, per level, so specify the text accordingly
Name: "{group}\GUI Wallet"; Filename: "{app}\gyro-wallet-gui.exe";
Name: "{group}\GUI Wallet Guide"; Filename: "{app}\gyro-gui-wallet-guide.pdf"; IconFilename: "{app}\gyro-wallet-gui.exe"
...
Name: "{group}\Utilities\Monero Daemon"; Filename: "{app}\gyrod.exe"; Parameters: {code:DaemonFlags}
...
Name: "{group}\Utilities\Textual (CLI) Wallet"; Filename: "{app}\gyro-wallet-cli.exe"; WorkingDir: "{userdocs}\Monero\wallets"
...
Name: "{group}\Utilities\x (Check GUI Wallet Log)"; Filename: "Notepad"; Parameters: """{userappdata}\gyro-wallet-gui\gyro-wallet-gui.log"""
Name: "{group}\Utilities\x (Try Daemon, Exit Confirm)"; Filename: "{app}\gyro-daemon.bat"
Name: "{group}\Utilities\x (Try GUI Wallet Low Graphics Mode)"; Filename: "{app}\start-low-graphics-mode.bat"
Name: "{group}\Utilities\x (Try Kill Daemon)"; Filename: "Taskkill.exe"; Parameters: "/IM gyrod.exe /T /F"

; Desktop icons, optional with the help of the "Task" section
Name: "{commondesktop}\GUI Wallet"; Filename: "{app}\gyro-wallet-gui.exe"; Tasks: desktopicon
...
Root: HKCU; Subkey: "Software\gyro-project"; Flags: uninsdeletekeyifempty
Root: HKCU; Subkey: "Software\gyro-project\gyro-core"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\gyro-project\gyro-core"; ValueType: string; ValueName: "blockchainDataDir"; ValueData: {code:BlockChainDirOrEmpty};
...
Root: HKCR; Subkey: "gyro"; ValueType: "string"; ValueData: "URL:Monero Payment Protocol"; Flags: uninsdeletekey
Root: HKCR; Subkey: "gyro"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCR; Subkey: "gyro\DefaultIcon"; ValueType: "string"; ValueData: "{app}\gyro-wallet-gui.exe,0"
Root: HKCR; Subkey: "gyro\shell\open\command"; ValueType: "string"; ValueData: """{app}\gyro-wallet-gui.exe"" ""%1"""

; Configure a custom URI scheme: Links starting with "gyroseed:" will start the GUI wallet exe with the URI as command-line parameter
; Used to easily hand over custom seed node info to the wallet, with an URI of the form "gyroseed://a.b.c.d:port"
Root: HKCR; Subkey: "gyroseed"; ValueType: "string"; ValueData: "URL:Monero Seed Node Protocol"; Flags: uninsdeletekey
Root: HKCR; Subkey: "gyroseed"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCR; Subkey: "gyroseed\DefaultIcon"; ValueType: "string"; ValueData: "{app}\gyro-wallet-gui.exe,0"
Root: HKCR; Subkey: "gyroseed\shell\open\command"; ValueType: "string"; ValueData: """{app}\gyro-wallet-gui.exe"" ""%1"""
